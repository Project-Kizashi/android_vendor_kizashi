...
ALARM_PATH := vendor/kizashi/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/kizashi/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/kizashi/prebuilt/common/media/audio/ringtones
